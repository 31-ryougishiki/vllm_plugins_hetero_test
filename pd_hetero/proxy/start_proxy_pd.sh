...
# 场景编排脚本导出的是 VLLM_PORT_START / DP_SIZE；这里保留旧变量名并回退，
# 否则用非默认端口/DP 跑场景时代理仍指向 9000..9003。
PREFILL_VLLM_PORT_START="${PREFILL_VLLM_PORT_START:-${VLLM_PORT_START:-9000}}"
PREFILL_DP_SIZE="${PREFILL_DP_SIZE:-${DP_SIZE:-4}}"
